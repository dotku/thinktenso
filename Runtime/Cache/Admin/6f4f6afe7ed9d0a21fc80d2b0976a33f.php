			...
			<form method="post">
				<table class="table table-bordered">
					<tr>
						...
						<td>
								<select name="pkg_id">
									<?php if(is_array($table)): $i = 0; $__LIST__ = $table;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["pkg_id"]); ?>">入库编号: <?php echo ($vo["pkg_id"]); ?> | 来源编号: <?php echo ($vo["pkg_orig_number"]); ?> | 客户编号: <?php echo ($vo["user_id"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
