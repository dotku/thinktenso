          ...
          <div class="row-fluid">
			...
			<form method="post">
				<table class="table table-bordered">
					...
					<tr>
						<th>支付金额
						<td><input type="text" name="item_user_email" class="input-xxlarge" placeholder="请输入金额(RMB)"></input></td>
					</tr>
				</table>
				<input type="hidden" name="item_status" value="shipping"/>
